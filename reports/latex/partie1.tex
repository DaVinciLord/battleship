...
\subsubsection{IA Moyen}
	...
	Le mode chasse indique à l'IA de tirer sur les quatre directions(nord, sud, est et ouest) entourant la case touchée et, si une nouvelle case est touchée, celle-ci part de cette dernière pour ainsi continuer jusqu'à avoir coulé le bateau.\newline
	Une fois le bateau coulé, notre IA reprends sa routine de "ciblage".\newline
...
\subsubsection{IA Difficile}
    ...
    La différence avec l'IA normale est que cette IA ne tire pas de case adjacente l'une à l'autre. En effet, suivant la taille minimal du bateau ennemi existant au début de partie, notre IA ne tire que que toutes les cases séparées d'une taille minimale du plus petit bateau.
